...
describe("Create Statement", () => {
  ...
  it("should not be able to create an deposit without amount", async () => {
    ...
    expect(response.body.message).toEqual(
      'Internal server error - null value in column "amount" of relation "statements" violates not-null constraint'
    );
  ...
  it("should not be able to create an deposit without description", async () => {
    ...
    expect(response.body.message).toEqual(
      'Internal server error - null value in column "description" of relation "statements" violates not-null constraint'
    );
    expect(response.status).toBe(500);
  });
