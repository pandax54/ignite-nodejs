...
let CreateCarSpecificationUseCase = (_dec = (0, _tsyringe.injectable)(), _dec2 = function (target, key) {
  ...
  async execute({
    ...
    const specifications = await this.specificationRepository.findByIds(specifications_id); // atribuir os valores das specifications ao carro

    car.specifications = specifications; // dar update nos valores do carro
